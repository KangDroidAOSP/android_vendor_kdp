...
ALARM_PATH := vendor/hexa/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/hexa/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/hexa/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/hexa/prebuilt/common/media/audio/ui
