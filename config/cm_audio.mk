...
ALARM_PATH := vendor/kdp/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/kdp/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/kdp/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/kdp/prebuilt/common/media/audio/ui
